...
namespace LibraryWeb.Migrations
{
    ...
    [Migration("20251028180607_AddPaymentReservationRelation")]
    partial class AddPaymentReservationRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LibraryWeb.Models.Reservation", b =>
                {
                    ...
                    b.HasOne("LibraryWeb.Models.Payment", "Payment")
                        .WithOne("Reservation")
                        .HasForeignKey("LibraryWeb.Models.Reservation", "PaymentID")
                        .OnDelete(DeleteBehavior.SetNull);
